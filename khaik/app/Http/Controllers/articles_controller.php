...
class articles_controller extends Controller
{
    ...
    public function index()
    {
        ...
        // $menu_head_items = DB::table('tbl_articles')->rightJoin('tbl_article_prices', 'tbl_articles.id', '=', 'tbl_article_prices.article_id')->where('restaurant_id', $restaurant_id[0]->id)->where('article_option', 'Head')->where('article_item_relations', NULL)->get();

        $menu_head_items2 = DB::table('tbl_article_prices')->rightJoin('tbl_articles', 'tbl_articles.id', '=', 'tbl_article_prices.article_id')->where('restaurant_id', $restaurant_id[0]->id)->where('article_option', 'Head')->where('article_item_relations', NULL)->get();


        // return $menu_head_items2;



        $menu_snack_items = DB::table('tbl_articles')->where('restaurant_id', $restaurant_id[0]->id)->where('article_option', 'Snacks')->where('article_item_relations', NULL)->get();
        ...
        foreach ($menu_head_items2 as $menu_head_item) {
            ...
            // echo $menu_option_items->article_id;
            // echo $menu_head_item->article_name;
            // return $menu_head_item->id;
