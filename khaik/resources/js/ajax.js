 ...
 var rest_lat = $('#restaurant_lat').val();
var rest_lon = $('#restaurant_lon').val();
...
function mapContent(){
		var api_key = 'it9lPTl5BXAg4L3Nx0TIvfl0COR67NWJ';
		var latAndLong = {lat: rest_lat, lng: rest_lon}; 
		var zoomLevel = 14;
		...
		var marker = new tt.Marker({color:'#d92662'}).setLngLat(latAndLong).addTo(map);
