<script type="text/javascript" src="{{asset('vendor_code/jquery/jquery.min.js')}}"></script>
<script type="text/javascript" src="{{asset('vendor_code/bootstrap/js/bootstrap.bundle.min.js')}}"></script>
<!-- slick Slider JS-->
