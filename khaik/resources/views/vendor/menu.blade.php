            ...
            <div class="col-md-7 pt-3">
                ...
                <div class="shadow-sm rounded bg-white mb-3 overflow-hidden">
                    ...
                    <div class="d-flex container border-bottom ">
                        ...
                        <button data-target="#sa" class=" btn btn-primary btn-block m-3"><i class="fa-solid fa-plus "></i> Add Option</button>
                    ...
                    <form action="{{route('add_article_option')}}" method="post">
                        ...
                        <p>Option Name</p>
                        <input type="text" name="option_name" id="">
                    ...
                    <div class="row m-0">
                        <a class="p-3 m-0 bg-light border-bottom w-100" data-toggle="collapse" aria-expanded="true" href="#{{$menu_main_option->option_name}}">
