                ...
                <div class="shadow-sm rounded bg-white mb-3 overflow-hidden">
                    ...
                    <div class="row m-0">
                        <a class="p-3 m-0 bg-light border-bottom w-100" data-toggle="collapse" aria-expanded="true" href="#multiCollapseExample1">
                            <h6>Main courses <small class="text-black-50">3 ITEMS</small></h6>
                        </a>
                    </div>
                    ...
                    <div class="row border-bottom px-0 collapse  show" id="multiCollapseExample1">
                        <div class=" col-5 p-3 gold-members d-flex flex-row">
                            <div class="col align-self-center">
                                <a href="#" data-toggle="modal" data-target="#modal{{$menu_item->article_name}}  ">
                                    <div class="media">
                                    ...
                                    <div class="media col border-bottom collapse " id="{{$menu_item->article_name}}">
                        ...
                        <div class=" col-7 p-3">
                            <div class="row d-flex flex-row justify-content-around">
                                <div class=" align-self-center ">
                                    <span><a class="btn btn-outline-secondary btn-sm " data-toggle="collapse" href="#{{$menu_item->article_name}}" role="button">Options</a></span>
                                </div>
                                <div class=" align-self-center ">
                                    <span><a data-toggle="collapse" href="#" role="button" class="btn btn-outline-secondary btn-sm ">Delete</a></span>
                                </div>
                                <div class=" align-self-center ">
                                    <span><a data-toggle="modal" data-target="#edit{{$menu_item->article_name}}  " role="button" class="btn btn-outline-secondary btn-sm ">Edit</a></span>
                                </div>
                    ...
                    <div class=" modal fade" id="edit{{$menu_item->article_name}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class=" modal fade" id="modal{{$menu_item->article_name}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
